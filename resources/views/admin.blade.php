...
<head>
  ...
  <!-- jvectormap -->
  <link rel="stylesheet" href="{{ URL::asset('css/admin/jquery-jvectormap.css') }}">
   <!-- DataTables -->
  <link rel="stylesheet" href="{{ URL::asset('css/admin/dataTables.bootstrap.min.css') }}">
  <!-- Theme style -->
...
<!-- AdminLTE App -->
<script src="{{ URL::asset('js/admin/adminlte.min.js') }}"></script>
<!-- Sparkline -->
<script src="{{ URL::asset('js/admin/jquery.sparkline.min.js') }}"></script>
<!-- jvectormap  -->
<script src="{{ URL::asset('js/admin/jquery-jvectormap-1.2.2.min.js') }}"></script>
<script src="{{ URL::asset('js/admin/jquery-jvectormap-world-mill-en.js') }}"></script>
<!-- DataTables -->
...
<!-- SlimScroll -->
<script src="{{ URL::asset('js/admin/jquery.slimscroll.min.js') }}"></script>
<!-- ChartJS -->
